    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            this.productTableAdapter.Fill
                (this.productDataSet.Product);

        }



        private void btFBU_Click(object sender, EventArgs e)
        {
            this.productTableAdapter.FillByUnits
                (this.productDataSet.Product);
        }

        private void btFBP_Click(object sender, EventArgs e)
        {
            this.productTableAdapter.FillByPrice
              (this.productDataSet.Product);
        }
    }
}
